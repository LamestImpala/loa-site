  ...
  return (
    <details className="mt-12 border-t border-white/10 pt-3">
      ...
      <ul className="mt-3 max-w-2xl space-y-2 text-sm leading-6 text-neutral-300">
        ...
        <li>The house plays its own calls: 1 unit on a LEAN, 2 on a LIKE, 3 on a BEST, at the number and price it saw when it made the call. It sits in the leaderboard with everyone else, so you can see whether fading it or following it is paying.</li>
        <li>The House Card is the house&apos;s strongest plays of the week, ranked by how much it likes them: five for college, three for the NFL. The top play is the lock of the week when it is a LIKE or better, the strongest plus-money play is the upset alert, and the closest game the house passes on all three ways is the one to stay away from. The house also projects a final score for each game, under &ldquo;lines &amp; house&rdquo;; a projection that contradicted its own spread or total call is not shown.</li>
